...
public unsafe class AutoBlockShutdownFromLobbyError : DailyModuleBase
{
    ...
    private static readonly CompSig AtkMessageBoxReceiveEventSig =
        new("40 53 48 83 EC 30 48 8B D9 49 8B C8 E8 ?? ?? ?? ?? 8B D0");
    ...
    {
        AtkMessageBoxReceiveEventHook ??=
            AtkMessageBoxReceiveEventSig.GetHook<AtkMessageBoxReceiveEventDelegate>(AtkMessageBoxReceiveEventDetour);
